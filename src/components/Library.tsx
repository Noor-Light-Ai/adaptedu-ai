...
import { BookOpen, Clock, Calendar, File, MoreHorizontal, PlusCircle, Search, TrendingUp } from 'lucide-react';
...
const Library = ({ courses }: LibraryProps) => {
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50">Your Library</h1>
            ...
            <Card key={course.id} className="overflow-hidden hover:shadow-md transition-shadow">
              <Link to={`/preview/${course.id}`} className="block">
                <div className="h-48 bg-gray-100 dark:bg-gray-800 relative">
                  ...
                  {course.trending && (
                    <Badge className="absolute top-3 right-3 bg-red-500 hover:bg-red-600 flex items-center gap-1">
              ...
              <CardFooter className="px-5 py-3 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 flex flex-col gap-2">
